...
export default class AlarmActionsForm extends React.Component {
  constructor(props) {
    super(props);
        ...
        <form className="smart-form" onSubmit={this.submit}>
          <fieldset>
            <label className="label" style={{ fontSize: '1.7rem', padding: '10px' }}>
              Alarm Action Edit ID: {this.state.id}
            </label>
          ...
          <footer>
            <div className="text-right">
              {this.state.loading && <img className="loading-wdna" alt="loading" src="assets/img/loading-wdna.gif" />}
