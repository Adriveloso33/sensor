...
export default class MainGraph2a extends React.Component {
  constructor(props) {
    super(props);
    this.pid = getStr();
    this.state = {
  ...
  setOptions1 = (graphType = 'spline') => {
    ...
    hc.setOption('title.text', 'Access by Area' || '');
  ...
  render() {
    let { accessbyarea, options1 } = this.state;
    let { props } = this;
