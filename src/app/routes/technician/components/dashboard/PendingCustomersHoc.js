...
class PendingCustomersHoc extends React.Component {
  constructor(props) {
    super(props);
    this.config = {
      buttons: {},
  ...
  render() {
    return [<Table data={this.state.data} buttons={this.config.buttons} loading={this.state.loading} />];
  }
}

export default PendingCustomersHoc;
